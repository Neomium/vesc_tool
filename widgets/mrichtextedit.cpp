...
MRichTextEdit::MRichTextEdit(QWidget *parent) : QWidget(parent) {
    ...
    f_undo->setIcon(Utility::getIcon("icons_textedit/Undo-96.png"));
    f_redo->setIcon(Utility::getIcon("icons_textedit/Undo-96.png"));
    f_cut->setIcon(Utility::getIcon("icons_textedit/Cut-96.png"));
    f_copy->setIcon(Utility::getIcon("icons_textedit/Copy-96.png"));
    f_paste->setIcon(Utility::getIcon("icons_textedit/Paste-96.png"));
    f_link->setIcon(Utility::getIcon("icons_textedit/Link-96.png"));
    f_image->setIcon(Utility::getIcon("icons_textedit/Add Image-96.png"));
    f_menu->setIcon(Utility::getIcon("icons_textedit/Menu 2-96.png"));
    f_bold->setIcon(Utility::getIcon("icons_textedit/Bold-96.png"));
    f_italic->setIcon(Utility::getIcon("icons_textedit/Italic-96.png"));
    f_underline->setIcon(Utility::getIcon("icons_textedit/Text Color-96.png"));
    f_strikeout->setIcon(Utility::getIcon("icons_textedit/Strikethrough-96.png"));
    f_list_bullet->setIcon(Utility::getIcon("icons_textedit/Bulleted List-96.png"));
    f_list_ordered->setIcon(Utility::getIcon("icons_textedit/Numbered List-96.png"));
    f_indent_dec->setIcon(Utility::getIcon("icons_textedit/Indent-96.png"));
    f_indent_inc->setIcon(Utility::getIcon("icons_textedit/Outdent-96.png"));
    f_bgcolor->setIcon(Utility::getIcon("icons_textedit/Fill Color-96.png"));
    f_fgcolor->setIcon(Utility::getIcon("icons_textedit/Fill Color-96.png"));
    f_align_left->setIcon(Utility::getIcon("icons_textedit/Align Left-96.png"));
    f_align_center->setIcon(Utility::getIcon("icons_textedit/Align Center-96.png"));
...
QString MRichTextEdit::toHtml() const {
    ...
    s = s.replace(QRegExp("(<[^a][^>]+>(?:<span[^>]+>)?|\\s)([a-zA-Z\\d]+@[a-zA-Z\\d]+\\.[a-zA-Z]+)").cap(), "\\1<a href=\"mailto:\\2\">\\2</a>");
    // convert links
    s = s.replace(QRegExp("(<[^a][^>]+>(?:<span[^>]+>)?|\\s)((?:https?|ftp|file)://[^\\s'\"<>]+)").cap(), "\\1<a href=\"\\2\">\\2</a>");
    return s;
}
